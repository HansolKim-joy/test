 ...
 */
@WebServlet("/fundingList.adm")
public class AdminFundingList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int ListCount = ds.getAdListCount();
		...
		ArrayList<DemandList> list = ds.adminFunding(currentPage, boardLimit);

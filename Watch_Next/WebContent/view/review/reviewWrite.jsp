...
<form>
	...
	<div id="revW_review">
		...
		&emsp;&emsp;&emsp;
		<input type="checkbox" id="revW_spolier" name="revW_spolier" value="스포있음"> 스포 있음</strong></h4>
	</div>
	<!-- 텍스트 편집기 부분 -->
	...
	<div id = "revW_roop">
		...
		<b id="pop_point" name="pop_point"></b>
		<input type="reset" value="취소" id="revW_button">
